...
export const metadata: Metadata = { title: "About", description: "How TinyGlyph turns plain text into copy-ready Unicode styles." };

export default function AboutPage() {
  return (
    <InfoPage
      eyebrow="About TinyGlyph"
      title="A small tool with one careful job."
      intro="TinyGlyph makes expressive Unicode text quick to explore, safe to copy, and pleasant to use."
      sections={[
        {
          title: "Why it exists",
          body: <><p>Most text generators bury a useful interaction beneath ads and repetitive content. TinyGlyph puts the converter first: type once, compare every result, and copy without opening a new page.</p><p>The interface is built for profile writers, community managers, creators, gamers, and anyone who wants a few words to carry a different tone.</p></>,
        },
        {
          title: "How conversion works",
          body: <><p>Each style maps ordinary Latin letters and numbers to Unicode characters with a similar visual form. Conversion happens locally in your browser and updates on every keystroke.</p><p>Unicode does not contain a complete superscript or subscript alphabet. When an exact counterpart is unavailable, TinyGlyph leaves the original character intact so the result stays understandable.</p></>,
        },
        {
